...
const copy = {
  en: {
    ...
    favoriteFoodTitle: 'Which foods does your family like more?',
    favoriteFoodHelp: 'Choose positive favourites MAMAAI should softly prefer while still keeping variety.',
    favoriteFoodCustom: 'Other favourite foods',
    favoriteFoodCustomPlaceholder: 'Example: Thai curry, tacos, millet dosa',
    addFavoriteFood: '+ Add favourite',
  ...
  hi: {
    ...
    favoriteFoodTitle: 'आपके परिवार को कौन-से भोजन अधिक पसंद हैं?',
    favoriteFoodHelp: 'ऐसी पसंद चुनें जिन्हें MAMAAI विविधता रखते हुए हल्की प्राथमिकता दे।',
    favoriteFoodCustom: 'अन्य पसंदीदा भोजन',
    favoriteFoodCustomPlaceholder: 'उदाहरण: थाई करी, टैकोस, बाजरे का डोसा',
    addFavoriteFood: '+ पसंद जोड़ें',
  ...
  kn: {
    ...
    favoriteFoodTitle: 'ನಿಮ್ಮ ಕುಟುಂಬಕ್ಕೆ ಯಾವ ಆಹಾರಗಳು ಹೆಚ್ಚು ಇಷ್ಟ?',
    favoriteFoodHelp: 'MAMAAI ವೈವಿಧ್ಯ ಉಳಿಸಿಕೊಂಡು ಮೃದುವಾಗಿ ಆದ್ಯತೆ ನೀಡಬೇಕಾದ ಇಷ್ಟಗಳನ್ನು ಆಯ್ಕೆ ಮಾಡಿ.',
    favoriteFoodCustom: 'ಇತರೆ ಇಷ್ಟದ ಆಹಾರಗಳು',
    favoriteFoodCustomPlaceholder: 'ಉದಾಹರಣೆ: Thai curry, tacos, millet dosa',
    addFavoriteFood: '+ ಇಷ್ಟ ಸೇರಿಸಿ',
